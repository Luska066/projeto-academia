        ...
        <div class="card">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item">@lang('Edit Planos Valor') #{{$planosValor->id}}</li>
                </ol>
            </div>
            <div class="card-body">
                <form action="{{ route('planos_valor.update', $planosValor->id) }}" method="POST" class="m-0 p-0">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                value="{{$planosValor->periodo ?: 'null'}}"
                            />
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="valor"
                                class="form-control decimal"
                                value="{{\App\Helpers\StringUtils::formatBRL($planosValor->valor) ?: 'null'}}"
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="desconto"
                                class="form-control"
                                value="{{\App\Helpers\StringUtils::formatBRL($planosValor->desconto) ?: 'null'}}"
                            />
                        ...
                        <div class="mb-3">
                            ...
                            >
                                @foreach(\App\Models\Plano::all() as $plano)
                                    <option
                                        @if($plano->id == $planosValor->id_plano)
                                            selected
                                        @endif
                                        value="{{$plano->id}}">
                                        {{$plano->nome}}
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            <a href="{{ route('planos_valor.index', []) }}" class="btn btn-light">Cancel</a>
                            <button type="submit" class="btn btn-primary">@lang('Update Planos Valor')</button>
                        </div>
                    </div>
                </form>
            </div>
